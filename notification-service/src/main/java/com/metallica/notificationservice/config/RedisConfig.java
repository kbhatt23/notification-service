 ...
 * org.springframework.data.redis.listener.RedisMessageListenerContainer; import
 ...
 * 
 * @Autowired private NotificationDBService notificationDBService;
 * 
 ...
 * template; }
 * 
 * //not needed here //need to add on listener
 * 
 * @Bean MessageListenerAdapter messageListener() { return new
 * MessageListenerAdapter(new RedisMessageSubscriber(notificationDBService)); }
 * 
 * 
